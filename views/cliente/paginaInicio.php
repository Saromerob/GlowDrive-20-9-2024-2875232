            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="form_agendar_cita.php">
                                <h6>Agendar Cita</h6>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link active" aria-current="page" href="Mapa.php">
                                <h6>Mapa</h6>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link active" aria-current="page" href="soli_gerente.php">
                                <h6>Solicitar "Gerente"</h6>
                            </a>
                        </li>
                        <li class="nav-item dropdown ">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link active" aria-current="page" href="resena.php">
                                <h6>Reseñas</h6>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link active" aria-current="page" href="respuesta_citas.php">
                                <h6>Citas enviadas</h6>
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link active" aria-current="page" href="ver_recibos.php">
                                <h6>Ver mis recibos</h6>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="app-description-container">
        <div class="content-wrapper">
            ...
            <p class="app-description">
                ...
                automóviles, facilitando la interacción entre usuarios y negocios locales.
            </p>
            <div class="image-wrapper">
                <img src="../../img/Carro.jpg" alt="Imagen de automóvil" class="app-image">
            </div>
        </div>
    </div>
