...
@media (max-width: 1200px) {
    .banner .text-content {
        max-width: 60%; /* Aumenta el ancho máximo en pantallas más pequeñas */
    }
}

@media (max-width: 992px) {
    .banner .text-content {
        max-width: 70%; /* Ajusta aún más el ancho máximo en pantallas medianas */
    }
}

@media (max-width: 768px) {
    .banner .text-content {
        max-width: 80%; /* Aumenta el ancho máximo en pantallas pequeñas */
    }
}

@media (max-width: 576px) {
    .banner .text-content {
        max-width: 90%; /* Aumenta el ancho máximo en pantallas muy pequeñas */
        padding: 0 10px; /* Reduce el espacio a los lados en pantallas muy pequeñas */
    }
}
