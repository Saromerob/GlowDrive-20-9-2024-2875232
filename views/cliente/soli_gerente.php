...
<head>
    ...
    <link rel="stylesheet" href="../styles/logoSoli.css">
    <style>
        .navbar {
...
/* Estilo del botón */
.btn-back {
    background-color: #f2f0d9; /* Color de fondo del botón */
    border: none;
    color: #18282e;
    font-weight: bold;
    padding: 8px 16px;
...
.btn-back:hover {
    background-color: #9faba7; /* Color al pasar el cursor */
    color: #fff;
}
...
<body>
    ...
    if (isset($_SESSION['pendiente'])) {
        echo '<div class="alert alert-danger fade-out">' . $_SESSION['pendiente'] . '</div>';
        unset($_SESSION['pendiente']); // Borra el mensaje después de mostrarlo
    }
    ?>
    ...
    <div class="container-fluid">
        <a class="navbar-brand d-flex align-items-center">
            <img src="../../img/logo.jpeg" alt="Logo" id="logo" class="logo me-2">
