                ...
                <div class="BOX">
                    ...
                    <div class="red-social">
                        ...
                        <a href="https://twitter.com" class="twitter">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                                class="bi bi-twitter icon-lg" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="https://facebook.com" class="facebook">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                                class="bi bi-facebook icon-lg" viewBox="0 0 16 16">
                                <path
                                    d="M8 1C4.318 1 1 4.318 1 8s3.318 7 7 7 7-3.318 7-7-3.318-7-7-7zM8 0c4.418 0 8 3.582 8 8s-3.582 8-8 8-8-3.582-8-8 3.582-8 8-8zm.4 8H6.839v4.889H5.34V8H4V6.866h1.34V5.94c0-1.092.547-2.15 2.117-2.15h1.504v1.317H8.6c-.312 0-.403.15-.403.385v1.376h1.552L9.62 8H8.4z" />
                            </svg>
                        </a>
                    </div>
                </div>
