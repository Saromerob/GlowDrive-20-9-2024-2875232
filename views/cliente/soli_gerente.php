                ...
                <div class="contenedor-principal">
                    ...
                    <section class="banner container">
                        <div class="text-content">
                            ...
                            <p>
                                Como equipo de desarrollo del SENA, hemos diseñado una aplicación móvil que conecta a
                                usuarios con servicios de lavado de automóviles cercanos.
                                Hemos creado una solución escalable y eficiente que permite a los usuarios encontrar y
                                reservar lavados de manera rápida y sencilla,
                    ...
                    <form action="" method="POST">
                        ...
                        <div>
                            ...
                            <label for="terms">Acepto los <a href="terminos.php" target="_blank">términos y
                                    condiciones</a></label>
                        </div>
                                ...
                                <div class="red-social">
                                    <a href="https://www.instagram.com" class="instagram">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                            fill="currentColor" class="bi bi-instagram icon-lg" viewBox="0 0 16 16">
                                            <path
                                    ...
                                    <a href="#" class="tik-tok">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                            fill="currentColor" class="bi bi-tiktok icon-lg" viewBox="0 0 16 16">
                                            <path
