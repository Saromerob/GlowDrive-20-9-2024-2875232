...
<head>
    ...
    font-family: 'Arial', sans-serif;
        ...
        .button {
    font-size: 1rem; /* Tamaño de fuente ajustado. Puedes cambiarlo según tus necesidades */
    border-radius: 10px;
    background-color: blue; /* Color de fondo corregido */
    color: white; /* Color del texto corregido */
    border: none; /* Opcional: para quitar el borde del botón si es necesario */
    padding: 0.5rem 1rem; /* Opcional: añade espacio dentro del botón */
    text-align: center; /* Opcional: centra el texto dentro del botón */
    cursor: pointer; /* Opcional: cambia el cursor al pasar sobre el botón */
    transition: background-color 0.3s ease; /* Opcional: agrega una transición suave para el color de fondo */
}

.button:hover {
    background-color: darkblue; /* Opcional: cambia el color de fondo cuando el ratón pasa sobre el botón */
}
...
<body>
    <div class="container">
        ...
        <button class="button" onclick="goBack();">Cerrar</button>

<script>
function goBack() {
    if (window.history.length > 1) {
        // Regresa a la página anterior si hay un historial
        window.history.back();
    } else {
        // Si no hay historial, puedes optar por redirigir a una página predeterminada
