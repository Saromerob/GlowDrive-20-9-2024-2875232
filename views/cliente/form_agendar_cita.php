    ...
    <div class="contenedor-principal">
        <nav class="navbar navbar-expand-lg custom-navbar">
            <div class="container-fluid">
                <a class="navbar-brand" href="form_agendar_cita.php">
        ...
        <div class="wrapper">
            <h1>Agendar Cita</h1>
            <form action="../../repository/agendar_cita.php" method="POST">
            ...
            <?php
                ...
                if (isset($_SESSION['success'])) {
                    echo '<div class="alert alert-success fade-out mt-2">' . $_SESSION['success'] . '</div>';
                    unset($_SESSION['success']); // Borra el mensaje después de mostrarlo
                }

                // Mostrar el mensaje de error
                if (isset($_SESSION['error'])) {
                    echo '<div class="alert alert-danger fade-out mt-2">' . $_SESSION['error'] . '</div>';
                ...
                xhr.onload = function() {
                    if (xhr.status === 200) {
                        ...
                        servicios.forEach(function(servicio) {
                            ...
                            option.textContent = servicio.nombre + ' - $' + servicio
                                .precio; // Mostrar nombre y precio
