...
<head>
    ...
    <link rel="stylesheet" href="../styles/verRecibos.css">
...
<body>
    <center>
        ...
        <ul>
            ...
            <li class="nav-item ubi">
                <a href="ver_recibo.php?id=<?php echo htmlspecialchars($recibo['id']); ?>"
                    target="_blank"><?php echo htmlspecialchars($recibo['nombre_archivo'],); ?>
                </a>
                <?php endforeach; ?>
            </li>
        </ul>
    ...
    <li class="nav-item">
        <div>
            <button type="button" class="btn" style="background-color: #007bff; border-color: #007bff; color: white;" onclick="window.location.href='paginaInicio.php';">
