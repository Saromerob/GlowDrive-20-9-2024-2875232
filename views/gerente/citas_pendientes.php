...
<head>
    ...
    <link rel="stylesheet" href="../styles/citas_pendientes.css">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr id="cita-<?php echo htmlspecialchars($cita['id']); ?>">
                        <td><?php echo htmlspecialchars($cita['nombre_servicio']) . ' - $' . htmlspecialchars($cita['precio_servicio']); ?>
                        </td> <!-- Mostrar nombre y precio del servicio -->
                        <td><?php echo htmlspecialchars($cita['nombre_cliente']) . " " . htmlspecialchars($cita['apellido_cliente']); ?>
                        </td>
                        ...
                        <td>
                            <button class="btn btn-success"
                                onclick="actualizarEstado(<?php echo $cita['id']; ?>, 'aceptar')">Aceptar</button>
                            <button class="btn btn-danger"
                                onclick="actualizarEstado(<?php echo $cita['id']; ?>, 'rechazar')">Rechazar</button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
