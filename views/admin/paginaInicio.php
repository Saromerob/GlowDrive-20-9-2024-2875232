...
<head>
    ...
    <style>
        ...
        .navbar-collapse {
            ...
            /* Centra las opciones de navegación */
        }
        ...
        .nav-item {
            margin: 0 20px;
            /* Espaciado uniforme entre los elementos de navegación */
        }
        ...
        @media (max-width: 768px) {
            ...
            .navbar-nav {
                ...
                /* Ajusta la disposición para pantallas pequeñas */
                align-items: center;
            }

            .nav-item {
                margin: 10px 0;
                /* Espaciado vertical entre los elementos de navegación */
            }
        }
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../perfil/cambiarcontragerente.php">Cambiar
                            Contraseña</a>
                    </li>
                </ul>
