...
<head>
    ...
    <link rel="stylesheet" href="../styles/adm_panel.css" >
</head>
<body>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td data-label="ID Solicitud"><?php echo htmlspecialchars($request['request_id']); ?></td>
            <td data-label="ID Usuario"><?php echo htmlspecialchars($request['user_id']); ?></td>
            <td data-label="Nombre Usuario"><?php echo htmlspecialchars($request['nombre']); ?></td>
            <td data-label="Email"><?php echo htmlspecialchars($request['correo']); ?></td>
            <td data-label="Rol Solicitado"><?php echo htmlspecialchars($request['requested_role_id']); ?></td>
            <td data-label="Estado"><?php echo htmlspecialchars($request['status']); ?></td>
