...
<center>
    ...
    <body>
        ...
        <form action="paginaInicio.php" method="post" style="display:inline;">
            <button type="submit" name="volverinicio"
                style="padding:10px 20px; background-color:#18282e; color:white; border:none; border-radius:5px; font-size:16px; cursor:pointer;">
                Volver al inicio
            </button>
        </form>
        <br>
