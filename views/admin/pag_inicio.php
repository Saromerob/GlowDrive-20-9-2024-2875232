...
<div align="center">
	<form method="POST" action="#" enctype="multipart/form-data">
		...
		NOMBRE 					<input type="number"     name="celular" value="<?php echo $usuario  ?>"> <br>
...
if(isset($_POST['actualizame']))
	...
	try {
	    $db = new Database(); // Crea una instancia de la clase Database
	    $conexion = $db->conectar(); // Obtiene la conexión PDO
	    $observar = "UPDATE usuarios SET nomusuario = '$actualizausuario',clave = ('$actualizaclave'),idrol = '$actualizaidrol',email = '$actualizaemail',foto ='$actualizafoto'  WHERE id = '$editar_id'";
