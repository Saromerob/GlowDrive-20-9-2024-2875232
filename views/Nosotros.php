...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styles/quienessomos.css">
    <style>
/* Estilo general del cuerpo y del fondo */
        ...
        <section class="about">
            <div class="container">
                ...
                <div class="about-text">
                    <h1>Quiénes Somos</h1>
                    <h5>Desarrolladores <span>& Diseñadores</span></h5>
                    <p>Somos un grupo de aprendices del SENA que se encuentran estudiando programación de Software y se nos ocurrió la idea de hacer un aplicativo sencillo para aquellas personas.</p>
                    <button class="btn"><a href="cliente/paginaInicio.php">Volver a inicio</a></button>
                </div>
            </div>
        </section>
    </main>
